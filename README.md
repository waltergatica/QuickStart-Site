...
<body>
    ...
    <section id="home" class="section">
      <div class="hero-card">
        <div>
          ...
          <div class="price-display">$3.49 per 12 oz can</div>
  ...
  <script>
    ...
    function addToCart() {
      alert("Quick Start Coffee Drink. Price: $3.49 per can. Online ordering is not enabled in this version of the site.");
    }
